...
namespace CoursesApplication.Web.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public CoursesController(IDataFetchService dataFetchService, ICourseService courseService)
        {
        ...
        public IActionResult Details(Guid? id)
        {
            ...
            ViewData["students"]=course.EnrolledStudents;
            return View(course);
        }
        ...
        {
            var newCourses = await dataFetchService.FetchCoursesFromApi();
            return RedirectToAction(nameof(Index));
        }
