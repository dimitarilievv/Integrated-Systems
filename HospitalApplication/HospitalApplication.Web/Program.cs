...
builder.Services.AddScoped(typeof(IRepository<TransferRequest>), typeof(Repository<TransferRequest>));
builder.Services.AddScoped(typeof(IRepository<PatientTransfer>), typeof(Repository<PatientTransfer>));
